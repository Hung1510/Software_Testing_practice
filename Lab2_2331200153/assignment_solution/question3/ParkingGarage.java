...
public class ParkingGarage {
     ...
     */
    public ParkingGarage(int totalCapacity) {
        if (totalCapacity <= 0) {
     ...
     * @throws InsufficientSpaceException If not enough space available
     * @throws VehicleAlreadyParkedException If vehicle is already in garage
     */
    public void enter(Vehicle vehicle) throws InsufficientSpaceException, VehicleAlreadyParkedException {
        if (vehicle == null) {
        ...
        if (parkedVehicles.containsKey(vehicle.getLicenseNumber())) {
            throw new VehicleAlreadyParkedException(vehicle.getLicenseNumber());
        }
     ...
     * @throws VehicleNotParkedException If vehicle is not in the garage
     */
    public void exit(String licenseNumber) throws VehicleNotParkedException {
        ...
        if (!parkedVehicles.containsKey(licenseNumber)) {
            throw new VehicleNotParkedException(licenseNumber);
        }
