...
public class PersonalNumberTest {
    ...
    public void testChecksumCalculation() {
        ...
        PersonalNumber pn1 = new PersonalNumber("6408233234");
        assertEquals(4, pn1.getCheckSum());
        
        // Additional test cases
        PersonalNumber pn2 = new PersonalNumber("8505152386");
        assertEquals(6, pn2.getCheckSum());
    }
    
    @Test
    public void testGetDate() {
        PersonalNumber pn = new PersonalNumber("6408233234");
    ...
    public void testGetYear() {
        ...
        PersonalNumber pn2 = new PersonalNumber("0001010123");
    ...
    public void testGetMonth() {
        ...
        PersonalNumber pn2 = new PersonalNumber("8512152386");
    ...
    public void testGetSex() {
        ...
        // Z = 1 (odd) -> Male
        PersonalNumber pn3 = new PersonalNumber("9203121015");
    ...
    public void testInvalidPersonalNumberLength() {
        // Too short
        new PersonalNumber("123");
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testInvalidPersonalNumberFormat() {
        // Contains non-digit characters
        new PersonalNumber("64082A3234");
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testInvalidChecksum() {
        // Correct format but wrong checksum (last digit should be 4, not 5)
        new PersonalNumber("6408233235");
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testInvalidMonth() {
        // Month 13 is invalid
        new PersonalNumber("6413233234");
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testInvalidDay() {
        // Day 32 is invalid
        new PersonalNumber("6408323234");
    }
    ...
    public void testEdgeCaseChecksumZero() {
        ...
        PersonalNumber pn = new PersonalNumber("7101011230");
