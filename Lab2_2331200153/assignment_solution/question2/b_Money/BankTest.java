...
public class BankTest {
	...
	public void testDeposit() throws AccountDoesNotExistException {
		...
		try {
			SweBank.deposit("NonExistent", new Money(1000, SEK));
	...
	public void testWithdraw() throws AccountDoesNotExistException {
		...
		try {
			SweBank.withdraw("NonExistent", new Money(1000, SEK));
			fail("Should throw AccountDoesNotExistException");
		} catch (AccountDoesNotExistException e) {
			// Expected
		}
	...
	public void testTransfer() throws AccountDoesNotExistException {
		...
		try {
			SweBank.transfer("NonExistent", "Bob", new Money(1000, SEK));
			fail("Should throw AccountDoesNotExistException");
		} catch (AccountDoesNotExistException e) {
			// Expected
		}
		...
		try {
			SweBank.transfer("Ulrika", "NonExistent", new Money(1000, SEK));
			fail("Should throw AccountDoesNotExistException");
		} catch (AccountDoesNotExistException e) {
			// Expected
		}
