public class Q2_Money implements Comparable<Q2_Money> {
	private int amount;
	 ...
	 */
	Q2_Money(int amount, Q2_Currency currency) {
		this.amount = amount;
	 ...
	 * @return Amount of money in Integer format.
	 */
	 ...
	 * Recall that we represent decimal numbers as integers. This means that the "10.5 SEK" mentioned
	 ...
	 * @return A Boolean indicating if the two monies are equal in value.
	 */
	public Boolean equals(Q2_Money other) {
	 ...
	 */
	public Q2_Money add(Q2_Money other) {
		int convertedAmount = currency.valueInThisCurrency(other.amount, other.currency);
		return new Q2_Money(this.amount + convertedAmount, this.currency);
	}
	 ...
	 */
	public Q2_Money sub(Q2_Money other) {
		int convertedAmount = currency.valueInThisCurrency(other.amount, other.currency);
		return new Q2_Money(this.amount - convertedAmount, this.currency);
	}
	 ...
	 * @return A new instance of the money class initialized with the negated amount.
	 */
	public Q2_Money negate() {
		return new Q2_Money(-amount, currency);
	}
	
	/**
	 * Compare two Monies.
	 * compareTo is required because the Money class implements the Comparable interface.
	 ...
	 */
	public int compareTo(Q2_Money other) {
