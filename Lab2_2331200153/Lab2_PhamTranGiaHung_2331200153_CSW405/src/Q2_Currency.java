public class Q2_Currency {
	 ...
	 */
	Q2_Currency(String name, Double rate) {
		this.name = name;
		this.rate = rate;
	}
	...
	*/
	public Integer valueInThisCurrency(Integer amount, Q2_Currency othercurrency) {
		// Convert other currency to universal value, then to this currency
		int universalAmount = othercurrency.universalValue(amount);
		return (int) Math.round(universalAmount / this.rate);
	}
}
