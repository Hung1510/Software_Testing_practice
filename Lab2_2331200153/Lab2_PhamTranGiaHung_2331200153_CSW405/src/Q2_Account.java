...
public class Q2_Account {
	private Q2_Money content;
	private Hashtable<String, TimedPayment> timedpayments = new Hashtable<String, TimedPayment>();

	Q2_Account(String name, Q2_Currency currency) {
		this.content = new Q2_Money(0, currency);
	}
	 ...
	 */
	public void addTimedPayment(String id, Integer interval, Integer next, Q2_Money amount, Q2_Bank tobank, String toaccount) {
	...
	public void tick() {
		for (TimedPayment tp : timedpayments.values()) {
			// tp.tick(); tp.tick(); error
			tp.tick(); //removed duplicate tp.tick() call
		}
	}
	 ...
	 */
	public void deposit(Q2_Money money) {
	 ...
	 */
	public void withdraw(Q2_Money money) {
	...
	private class TimedPayment {
		...
		private Q2_Account fromaccount;
		private Q2_Money amount;
		private Q2_Bank tobank;
		private String toaccount;

		TimedPayment(Integer interval, Integer next, Q2_Money amount, Q2_Account fromaccount, Q2_Bank tobank, String toaccount) {
